...
if __name__ == '__main__':
    ...
    data_gan = get_data(bs=BS, sz=SZ, path_dataset=PATH_PROJECT_DATA, xtra_tfms=xtra_tfms)
    ...
    for cycle in range(num_cycles):
        ...
        colorizer = get_stable_video_colorizer(root_folder=Path('data'))
        colorizer_test(colorizer.vis, index=cycle)
        fid_scores.append(calculate_csv_fid(colorizer.vis, "data/val.csv"))
